    ...
    <div class="row">
        <div class="col-sm-4">
                ...
                <?php if (file_exists('output.png')) 
                    { ?>
                                    <img id="previewing" width="80%" height="80%" src="<?php echo 'http://'.$_SERVER[HTTP_HOST].$_SERVER[REQUEST_URI].'/'.'output.png'?>" />
                                    <a href="<?php echo 'http://'.$_SERVER[HTTP_HOST].$_SERVER[REQUEST_URI].'/'.'output.png'?>" download>Download</a>

                    <?php } else {?>
                        <img id="previewing" width="80%" height="90%" src="<?php echo 'http://'.$_SERVER[HTTP_HOST].$_SERVER[REQUEST_URI].'/'.'template.png'?>" />
                    <?php } ?>
                </div>
